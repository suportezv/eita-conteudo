#!/usr/bin/env bash
# Validação do EITA Conteúdo Studio. Itens de MCP (Metricool, Kairogen)
...
for D in https://drive.google.com/ https://drive.usercontent.google.com/ https://api.elevenlabs.io/v1/user \
         https://api.openai.com/v1/models https://generativelanguage.googleapis.com/v1beta/models \
         https://www.googleapis.com/; do
...
echo " - Metricool: getBrandSettings lista a marca eita.mentoravirtual com blog_id 6735014"
echo " - Kairogen: get_me_context mostra plano Essential e créditos (conta suporte@zavi.ag)"
